...
class Select extends BaseComponent {
    selectors = {
        root: rootSelector,
        originalControl: "[data-js-select-origin-control]",
    ...
    updateUi() {
        ...
        const newSelectorOptionValue = selectedOptionElement.textContent.trim();

        const updateOriginalControl = () => {
            this.originalControlElement.value = newSelectorOptionValue;
        };

        const updateButton = () => {
            this.buttonElement.textContent = newSelectorOptionValue;
    ...
    bindEvents() {
        ...
        this.originalControlElement.addEventListener("change", this.onOriginControlChange);
    }
}
